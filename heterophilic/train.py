...
if __name__ == "__main__":
    ...
    for i in range(10):
        t1=time.time()
        print("epoch = ", i)
        params={"lr_rate_mul":0.1,"alpha":0.3,"lambda":0.4,"gamma":0.2,"wd1":0.05,"wd2":0.0009,"dropout":0.6,"hidden":64,"myf":0.5}
        #params={"lr_rate_mul":0.1,"alpha":0.1,"lambda":0.5,"gamma":0.2,"wd1":0.01,"wd2":0.0005,"dropout":0.6,"hidden":64,"myf":0.5}
