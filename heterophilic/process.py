...
def full_load_data(dataset_name, splits_file_path=None):
    ...
    if dataset_name in {'cora', 'citeseer', 'pubmed'}:
        ...
        graph_adjacency_list_file_path = os.path.join(path+'new_data', dataset_name, 'out1_graph_edges.txt')
        graph_node_features_and_labels_file_path = os.path.join(path+'new_data', dataset_name,
